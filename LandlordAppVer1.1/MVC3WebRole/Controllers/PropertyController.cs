...
namespace MVC3WebRole.Controllers
{
    public class PropertyController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            var tableStorageItems = from items in context.CreateQuery<Property>("MyAzureTable") where items.PartitionKey == "Property" select items;
        ...
        public ActionResult Details(string PartitionKey, string RowKey  /*int id*/)
        {
            ...
            var result = (from item in context.CreateQuery<Property>("MyAzureTable")
        ...
        [HttpPost]
        public ActionResult Edit(Property modifiedItem /*int id, FormCollection collection*/)
        {
            try
            {
                //Initialize variables needed to manipulate table
        ...
        [HttpPost]
        public ActionResult Delete(Property itemToDelete /*int id, FormCollection collection*/)
        {
            try
            {
              // PartitionKey = "Property";
