...
namespace MVC3WebRole.Controllers
{
    public class TenancyController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            var tableStorageItems = from items in context.CreateQuery<Tenancy>("MyAzureTable") where items.PartitionKey == "Tenancy" select items;
        ...
        public ActionResult Details(string PartitionKey, string RowKey  /*int id*/)
        {
            ...
            var result = (from item in context.CreateQuery<Tenancy>("MyAzureTable")
        ...
        [HttpPost]
        public ActionResult Create(Tenancy item)
        {
            try
            {
                //Initialize variables needed to manipulate table
        ...
        [HttpPost]
        public ActionResult Edit(Tenancy modifiedItem /*int id, FormCollection collection*/)
        {
            try
            {
                //Initialize variables needed to manipulate table
        ...
        public ActionResult Delete(string PartitionKey, string RowKey /*int id*/)
        {
            ...
            //Fetch item from table to display old values on the delete confirmation page
        ...
        [HttpPost]
        public ActionResult Delete(Tenancy itemToDelete /*int id, FormCollection collection*/)
        {
            try
            {
                //Initialize variables needed to manipulate table
